...
func TestApplyAction_StealthConfigToggle(t *testing.T) {
	tests := []struct {
		actionIdx int
		fieldName string
		checkFunc func(cfg *chromestealth.StealthConfig) bool
	}{
		{0, "RemoveWebDriver", func(c *chromestealth.StealthConfig) bool { return c.RemoveWebDriver }},
		{1, "CanvasNoise", func(c *chromestealth.StealthConfig) bool { return c.CanvasNoise }},
		{2, "ClientHints", func(c *chromestealth.StealthConfig) bool { return c.ClientHints }},
		{3, "RandomUserAgent", func(c *chromestealth.StealthConfig) bool { return c.RandomUserAgent }},
		{4, "WebGLSpoof", func(c *chromestealth.StealthConfig) bool { return c.WebGLSpoof }},
		{5, "HardwareSync", func(c *chromestealth.StealthConfig) bool { return c.HardwareSync }},
		{6, "NetworkSync", func(c *chromestealth.StealthConfig) bool { return c.NetworkSync }},
		{7, "PluginsSync", func(c *chromestealth.StealthConfig) bool { return c.PluginsSync }},
		{8, "GeometrySync", func(c *chromestealth.StealthConfig) bool { return c.GeometrySync }},
		{9, "VideoSync", func(c *chromestealth.StealthConfig) bool { return c.VideoSync }},
		{10, "PermissionsSync", func(c *chromestealth.StealthConfig) bool { return c.PermissionsSync }},
		{11, "TimezoneSync", func(c *chromestealth.StealthConfig) bool { return c.TimezoneSync }},
	}
