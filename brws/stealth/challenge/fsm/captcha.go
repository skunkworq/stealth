...
type CaptchaSubmitFunc func(verifyURL, challengeID, solution string, events []challenge.CaptchaEvent) (bool, error)

// CaptchaEventsFunc generates human-like events.
type CaptchaEventsFunc func(solveTimeMs int64, solution string) []challenge.CaptchaEvent
