...
type TurnstileInteractionConfig struct {
	...
	AngleToleranceDeg    int `json:"angle_tolerance_deg,omitempty"`
	DialRadiusPx         int `json:"dial_radius_px,omitempty"`
	MinRotationEvents    int `json:"min_rotation_events,omitempty"`
	RequiredOvershootDeg int `json:"required_overshoot_deg,omitempty"`

	// Slide puzzle challenge
	TargetSlideXPx       int `json:"target_slide_x_px,omitempty"`
	SlideTolerancePx     int `json:"slide_tolerance_px,omitempty"`
	SlideTrackWidthPx    int `json:"slide_track_width_px,omitempty"`
	MinSlideEvents       int `json:"min_slide_events,omitempty"`
	RequiredSlideYJitter int `json:"required_slide_y_jitter,omitempty"`
}
...
type TurnstileInteractionProof struct {
	...
	AngularVelocityAvg float64 `json:"angular_velocity_avg,omitempty"`

	// Slide puzzle proof
	FinalSlideXPx    int     `json:"final_slide_x_px,omitempty"`
	SlideEventCount  int     `json:"slide_event_count,omitempty"`
	SlideYVariancePx float64 `json:"slide_y_variance_px,omitempty"`
...
func turnstileWidgetConfigForRisk(sessionID string, detectionScore float64) TurnstileWidgetConfig {
	...
	case detectionScore >= 0.95:
		...
		cfg.Interaction = turnstileRotateConfig(270)
