// Package tracker records real mouse, keyboard, and scroll events from a live
// browsing session and exports them as behavior.EventData snapshots. This is
// distinct from the parent behavior package, which generates synthetic
// human-like events from scratch.
package tracker
...
// New creates a new tracker starting from now.
func New() *BehavioralTracker {
