...
// DynamicFSMSolver wraps the adversarial.DynamicSolver behind the
...
type DynamicFSMSolver struct {
	solver *adversarial.DynamicSolver
	engine engine.Engine
}

// NewDynamicFSMSolver creates a solver backed by the dynamic solver.
func NewDynamicFSMSolver(solver *adversarial.DynamicSolver, eng engine.Engine) *DynamicFSMSolver {
...
func (s *DynamicFSMSolver) Events(body []byte, headers map[string][]string) []adversarial.CaptchaEvent {
