...
type CFDetectFunc func(resp *engine.Response) *adversarial.CloudflareChallenge

// CFSolveFunc is a function that solves a detected CF challenge and returns a new response.
type CFSolveFunc func(ctx context.Context, targetURL string, resp *engine.Response, ch *adversarial.CloudflareChallenge) (*engine.Response, error)
