...
func TestSwordDoesNotTrigger(t *testing.T) {
	...
	req.Header.Set("X-Screen-Data", `{"width":1920,"height":1080,"avail_width":1920,"avail_height":1040,"color_depth":24,"pixel_ratio":1.0,"outer_width":1920,"outer_height":1040,"inner_width":1903,"inner_height":969,"orientation_type":"landscape-primary","orientation_angle":0}`)
