...
func NewReCaptchaWidget(shield *CaptchaShield) *ReCaptchaWidget {
...
func eventsToEnhanced(events []CaptchaEvent) *EnhancedBehavioralEvents {
...
func buildBehavioralBreakdown(result *VectorResult, enhanced *EnhancedBehavioralEvents, totalEvents int) map[string]interface{} {
