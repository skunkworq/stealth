...
func TestPhases79_80Integration(t *testing.T) {
	...
	if !hasGeometryMismatch { t.Errorf("Phase 79 detection failed: missing screen_avail_geometry_mismatch in %v", fired1) }
	if !hasPrototypeMismatch { t.Errorf("Phase 80 detection failed: missing navigator_prototype_mismatch in %v", fired1) }
