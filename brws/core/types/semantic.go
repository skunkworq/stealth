...
// SemanticPage is the interface that stealth.Response uses to delegate
// extraction to a pre-built semantic tree without importing content/understand.
// content/understand.SemanticTree implements this interface.
type SemanticPage interface {
	GetMeta() *PageMeta
