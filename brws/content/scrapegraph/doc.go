...
//
//	func main() {
//	    llm := understand.NewLLMClient(os.Getenv("OPENROUTER_API_KEY"))
//
...
//	}
//
// A wrapper around the existing understand.LLMClient is provided out of the box:
//
...
// It relies only on brws/content/understand for the default LLM client and
