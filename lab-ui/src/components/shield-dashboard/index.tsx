...
function ShieldDashboardResults({ data }: { data: ShieldEvalResponse }) {
  return (
    <>
      <Panel>
...
export function ShieldDashboard() {
  ...
  return (
    <div className="space-y-5">
      <Panel>
        ...
        <PanelContent>
          <PanelSection title="Run Evaluation">
            <EvaluationToolbar loading={loading} error={error} onRun={runEvaluation} />
          </PanelSection>
      ...
      {data && <ShieldDashboardResults data={data} />}
    </div>
  );
}
